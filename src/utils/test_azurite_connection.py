...
def run_diagnostics():
    ...
    print("--- AZURITE REMOTE DIAGNOSTICS ---")
    ...
    try:
        ...
        if test_container not in existing_names:
            ...
            print("   [INFO] Test container already exists (Write access verified previously).")
        ...
        print(f"Details: {e}")
        print("\nTroubleshooting:")
        print("1. Verify Azurite is running on the target host.")
