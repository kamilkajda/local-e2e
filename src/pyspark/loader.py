...
try:
    ...
    print(
        "[!] ERROR: azure-storage-blob is missing. "
        "Please install the package to enable cloud loading."
    )
...
def save_to_azurite(df: DataFrame, metric_name: str, config: dict) -> None:
    ...
    try:
        ...
        blob_service_client = BlobServiceClient.from_connection_string(
            conn_str, api_version="2021-08-06"
        )
        ...
        print("      [Loader] Cloud synchronization successful.")
